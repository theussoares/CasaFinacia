<template>
  <div v-if="session.isAuthReady" class="p-4 sm:p-6 lg:p-8 flex-col">
    <header class="mb-8">
    ...
    <div v-else class="text-center py-20">
      <p class="text-gray-600">
        Ocorreu um erro ao carregar a sua sessão. Por favor, tente fazer login
        novamente.
      </p>
    </div>
  ...
  <div v-else class="flex flex-col justify-center min-h-screen">
    <p class="text-gray-500">A verificar sessão...</p>
  </div>
</template>
